...
So my team was using sprints as a week period. Every week, unfinished tasks were moved to new sprint.
...
> At the next meeting each member tells the status of their tasks and "Planning master" makes appropriate changes in section **Week 2**.
