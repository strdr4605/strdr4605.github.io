...
His team was using a ticketing tool that was build mostly for Scrum.
...
So his team was using sprints as a week period. Every week, unfinished tasks were moved to new sprint.
...
At the next meeting each member tells the status of their tasks and "Planning master" makes appropriate changes in section **Week 2**. <br/>
Next the "Planning master" will copy section **Week 2** above and rename it to **Week 3**. <br/>
...
Although it's not an ideal solution, it worked pretty for my friend team.
...
After trying, I would apreciate any feedback on using this approach.
