...
date: 2022-01-11
description: A guide to customize the commitlint to your need and use it as convention in your git repository. Costumize commitlint header format to use emojis.
tags:
  - tools
  - git
  - npm
