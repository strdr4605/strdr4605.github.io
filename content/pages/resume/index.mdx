...
- `20.12.2018–PRESENT` **[GoParrot.ai](https://www.goparrot.ai/)** | Online Ordering Platform on _Microservices Architecture_<br/>
I am responsible for a white-label mobile product with 7+ apps.<br/>
My team and I work on a new version of the Platform using _React Native_/_ReactJS_ with 40%+ code shared between mobile and web.<br/>
