...
It may be a not very useful package, but while working on it I learned a lot, and steal consider it as amazing piece of software.
...
I worked with React Native Modules and wrote some Kotlin and Swift. There are non-async replacements for this library, but it's steal [used](https://www.npmjs.com/package/@goparrot/react-native-geometry-utils).
